/*
  # Fix Labor Cost Function Type Casting

  1. Changes
    - Update function parameter to accept both text and uuid
    - Add proper type casting for customer_id comparisons
    - Ensure all queries handle customer_id as uuid correctly
*/

-- Drop and recreate function with proper type handling
