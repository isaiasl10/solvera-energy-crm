/*
  # Fix Labor Cost Calculation with Correct Time Clock Columns

  1. Changes
    - Update function to use correct column names:
      - clock_in_time instead of clock_in
      - clock_out_time instead of clock_out
    - Ensure proper calculation of hourly labor costs
*/
