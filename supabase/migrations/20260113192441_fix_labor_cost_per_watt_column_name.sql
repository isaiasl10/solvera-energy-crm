/*
  # Fix Labor Cost Calculation - Use Correct Column Name

  1. Changes
    - Update function to use per_watt_rate instead of ppw_rate
    - This is the actual column name in app_users table
*/
