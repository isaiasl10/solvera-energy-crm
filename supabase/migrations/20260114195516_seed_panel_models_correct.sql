/*
  # Seed Solar Panel Models

  Seeds the panel_models table with common solar panel models (400-590W) from:
  - Aptos
  - Silfab
  - Jinko
  - Canadian Solar
  ...
  Note: Dimensions are in millimeters. Standard panels are approximately 1650-2100mm x 1000-1100mm
*/
