...
import { User, DollarSign, Clock, TrendingUp, Calendar, Lock } from 'lucide-react';
...
export default function EmployeeProfileView() {
  const [activeTab, setActiveTab] = useState<'payment' | 'timeclock' | 'overrides' | 'payroll' | 'security'>('payment');
