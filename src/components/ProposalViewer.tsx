...
export default function ProposalViewer({ proposalId, onClose }: ProposalViewerProps) {
  ...
  if (loading) {
    return (
      <div style={{
        ...
        <div style={{ color: '#fff', fontSize: 18, fontWeight: 600 }}>Loading proposal...</div>
      </div>
    );
  }
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            <h2 style={{ fontSize: 20, fontWeight: 700, color: '#111827', margin: 0 }}>Solar Proposal</h2>
          </div>
        ...
        <div style={{ flex: 1, overflow: 'auto', padding: 40 }}>
          <div ref={proposalRef} style={{ background: '#fff', minHeight: '100%' }}>
            <div style={{
              textAlign: 'center',
              paddingBottom: 40,
